...
//	TFile *hfile1= new TFile("test203056.root", "READ");        
	...
	//    getchar();
	//
          TPostScript psfile ("zcalibTSmax.ps", 111);
//
   ...
   c1 = new TCanvas("c1","Hcal4test",200,10,700,900);
    ...
    //======================================================================
      c1->Clear();
      c1->Divide(2,2);
      TH2F *twod1= (TH2F*)hfile1->Get("h_mapTSmaxCalib_HB");
	...
	Cefz225->Sumw2();
      ...
      c1->cd(2);
      TH1F *aaaaaa1= (TH1F*)hfile1->Get("h_TSmaxCalib_HB");
      gPad->SetLogy();
      aaaaaa1->SetMarkerStyle(20);
      aaaaaa1->SetMarkerSize(0.8);
      aaaaaa1->GetYaxis()->SetLabelSize(0.04);
      aaaaaa1->SetXTitle("TSmaxCalib in each event & cell HB\b");
    ...
    for (int i=1;i<=nx;i++) {
      ...
      Diffe_HB->SetZTitle("<TSmaxCalib> for 0 & 9  HB \b");
      ...
      c1->cd(4);
      TH1F* diffAmplitude_HB = new TH1F("diffAmplitude_HB","", 100, 0., 10.);
      int nx = Ceff->GetXaxis()->GetNbins();
      int ny = Ceff->GetYaxis()->GetNbins();
      for (int i=1;i<=nx;i++) {
	for (int j=1;j<=ny;j++) {
      ...
      diffAmplitude_HB->SetXTitle("<TSmaxCalib> in each cell HB\b");
    ...
    //======================================================================
      c1->Clear();
      c1->Divide(2,2);
      TH2F *twod1= (TH2F*)hfile1->Get("h_mapTSmaxCalib_HE");
	...
	Ceff->Sumw2();
      ...
      c1->cd(1);
      TH2F *twod1= (TH2F*)hfile1->Get("h_mapTSmaxCalib047_HE");
      TH2F *twod0= (TH2F*)hfile1->Get("h_map_HE");
      twod1->Sumw2();
      twod0->Sumw2();
      if(twod0->IsA()->InheritsFrom("TH2F")){
	...
	Cefz225->Sumw2();
      ...
      c1->cd(2);
      TH1F *aaaaaa1= (TH1F*)hfile1->Get("h_TSmaxCalib_HE");
      gPad->SetLogy();
      aaaaaa1->SetMarkerStyle(20);
      aaaaaa1->SetMarkerSize(0.8);
      aaaaaa1->GetYaxis()->SetLabelSize(0.04);
      aaaaaa1->SetXTitle("TSmaxCalib in each event & cell HE\b");
      aaaaaa1->SetMarkerColor(2);
      aaaaaa1->SetLineColor(2);
      aaaaaa1->SetMinimum(0.8);
      aaaaaa1->Draw("");
    ...
    for (int i=1;i<=nx;i++) {
	  ...
	  if(ccc1 < 0.5 || ccc1> 8.5  )  Diffe_HE->SetBinContent(i,j,ccc1);
      }
    }
      gPad->SetGridy();
      gPad->SetGridx();
      ...
      Diffe_HE->SetZTitle("<TSmaxCalib> for 0 & 9  HE \b");
      ...
      c1->cd(4);
      TH1F* diffAmplitude_HE = new TH1F("diffAmplitude_HE","", 100, 0., 10.);
      int nx = Ceff->GetXaxis()->GetNbins();
      int ny = Ceff->GetYaxis()->GetNbins();
      for (int i=1;i<=nx;i++) {
	for (int j=1;j<=ny;j++) {
      ...
      diffAmplitude_HE->SetXTitle("<TSmaxCalib> in each cell HE\b");
    ...
    //======================================================================
      c1->Clear();
      c1->Divide(2,2);
      TH2F *twod1= (TH2F*)hfile1->Get("h_mapTSmaxCalib_HO");
	...
	Ceff->Sumw2();
      ...
      c1->cd(1);
      TH2F *twod1= (TH2F*)hfile1->Get("h_mapTSmaxCalib047_HO");
      TH2F *twod0= (TH2F*)hfile1->Get("h_map_HO");
      twod1->Sumw2();
      twod0->Sumw2();
      if(twod0->IsA()->InheritsFrom("TH2F")){
	...
	Cefz225->Sumw2();
      ...
      c1->cd(2);
      TH1F *aaaaaa1= (TH1F*)hfile1->Get("h_TSmaxCalib_HO");
      gPad->SetLogy();
      aaaaaa1->SetMarkerStyle(20);
      aaaaaa1->SetMarkerSize(0.8);
      aaaaaa1->GetYaxis()->SetLabelSize(0.04);
      aaaaaa1->SetXTitle("TSmaxCalib in each event & cell HO\b");
      aaaaaa1->SetMarkerColor(2);
      aaaaaa1->SetLineColor(2);
      aaaaaa1->SetMinimum(0.8);
      aaaaaa1->Draw("");
    ...
    for (int i=1;i<=nx;i++) {
	  ...
	  if(ccc1 < 0.5 || ccc1> 8.5 )  Diffe_HO->SetBinContent(i,j,ccc1);
      }
    }
      gPad->SetGridy();
      gPad->SetGridx();
      ...
      Diffe_HO->SetZTitle("<TSmaxCalib> for 0 & 9  HO \b");
      ...
      c1->cd(4);
      TH1F* diffAmplitude_HO = new TH1F("diffAmplitude_HO","", 100, 0., 10.);
      int nx = Ceff->GetXaxis()->GetNbins();
      int ny = Ceff->GetYaxis()->GetNbins();
      for (int i=1;i<=nx;i++) {
	for (int j=1;j<=ny;j++) {
      ...
      diffAmplitude_HO->SetXTitle("<TSmaxCalib> in each cell \b");
    ...
    //======================================================================
      c1->Clear();
      c1->Divide(2,2);
      TH2F *twod1= (TH2F*)hfile1->Get("h_mapTSmaxCalib_HF");
	...
	Ceff->Sumw2();
      ...
      c1->cd(1);
      TH2F *twod1= (TH2F*)hfile1->Get("h_mapTSmaxCalib047_HF");
      TH2F *twod0= (TH2F*)hfile1->Get("h_map_HF");
      twod1->Sumw2();
      twod0->Sumw2();
      if(twod0->IsA()->InheritsFrom("TH2F")){
	...
	Cefz225->Sumw2();
      ...
      c1->cd(2);
      TH1F *aaaaaa1= (TH1F*)hfile1->Get("h_TSmaxCalib_HF");
      gPad->SetLogy();
      aaaaaa1->SetMarkerStyle(20);
      aaaaaa1->SetMarkerSize(0.8);
      aaaaaa1->GetYaxis()->SetLabelSize(0.04);
      aaaaaa1->SetXTitle("TSmaxCalib in each event & cell HF\b");
      aaaaaa1->SetMarkerColor(2);
      aaaaaa1->SetLineColor(2);
      aaaaaa1->SetMinimum(0.8);
      aaaaaa1->Draw("");
    ...
    for (int i=1;i<=nx;i++) {
	  ...
	  if(ccc1 < 0.5 || ccc1> 8.5 )  Diffe_HF->SetBinContent(i,j,ccc1);
      }
    }
      gPad->SetGridy();
      gPad->SetGridx();
      ...
      Diffe_HF->SetZTitle("<TSmaxCalib> for 0 & 9  HF \b");
      ...
      c1->cd(4);
      TH1F* diffAmplitude_HF = new TH1F("diffAmplitude_HF","", 100, 0., 10.);
      int nx = Ceff->GetXaxis()->GetNbins();
      int ny = Ceff->GetYaxis()->GetNbins();
      for (int i=1;i<=nx;i++) {
	for (int j=1;j<=ny;j++) {
      ...
      diffAmplitude_HF->SetXTitle("<TSmaxCalib> in each cell \b");
