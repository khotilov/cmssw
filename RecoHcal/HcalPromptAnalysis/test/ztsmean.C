...
//
   ...
   c1 = new TCanvas("c1","Hcal4test",200,10,700,900);
    ...
    //======================================================================
      ...
      TH2F *twod1= (TH2F*)hfile1->Get("h_mapDepth1TSmeanA_HB");
    ...
    for (int i=1;i<=nx;i++) {
	  ...
	  if(ccc1 < 2.3 || ccc1>5. )  Diffe_Depth1_HB->SetBinContent(i,j,ccc1);
      }
    }
      gPad->SetGridy();
      gPad->SetGridx();
      ...
      Diffe_Depth1_HB->SetZTitle("<TSmeanA> out 2.3-5 - HB Depth1 \b");
      ...
      c1->cd(4);
      TH1F* diffTSmeanA_Depth1_HB = new TH1F("diffTSmeanA_Depth1_HB","", 100, -1.,11.);
      int nx = Ceff->GetXaxis()->GetNbins();
      int ny = Ceff->GetYaxis()->GetNbins();
      for (int i=1;i<=nx;i++) {
	for (int j=1;j<=ny;j++) {
    ...
    //======================================================================
      ...
      TH2F *twod1= (TH2F*)hfile1->Get("h_mapDepth2TSmeanA_HB");
	...
	Ceff->Sumw2();
      ...
      c1->cd(1);
      TH2F *twod1= (TH2F*)hfile1->Get("h_mapDepth2TSmeanA225_HB");
      TH2F *twod0= (TH2F*)hfile1->Get("h_mapDepth2_HB");
      twod1->Sumw2();
      twod0->Sumw2();
      if(twod0->IsA()->InheritsFrom("TH2F")){
	...
	Cefz225->Sumw2();
      ...
      Cefz225->SetXTitle("#eta \b");
      Cefz225->SetYTitle("#phi \b");
      Cefz225->SetZTitle("Rate for TSmeanA in each event & cell out 2.3-5 - HB Depth2 \b");
      Cefz225->SetMarkerColor(2);
      Cefz225->SetLineColor(2);
      Cefz225->Draw("COLZ");
    ...
    for (int i=1;i<=nx;i++) {
	  ...
	  if(ccc1 < 2.3 || ccc1>5.)  Diffe_Depth2_HB->SetBinContent(i,j,ccc1);
      }
    }
      gPad->SetGridy();
      gPad->SetGridx();
      ...
      Diffe_Depth2_HB->SetZTitle("<TSmeanA> out 2.3-5 - HB Depth2 \b");
      ...
      c1->cd(4);
      TH1F* diffTSmeanA_Depth2_HB = new TH1F("diffTSmeanA_Depth2_HB","", 100, -1.,11.);
      int nx = Ceff->GetXaxis()->GetNbins();
      int ny = Ceff->GetYaxis()->GetNbins();
      for (int i=1;i<=nx;i++) {
	for (int j=1;j<=ny;j++) {
    ...
    //======================================================================
      ...
      TH2F *twod1= (TH2F*)hfile1->Get("h_mapDepth1TSmeanA_HE");
	...
	Ceff->Sumw2();
      ...
      c1->cd(1);
      TH2F *twod1= (TH2F*)hfile1->Get("h_mapDepth1TSmeanA225_HE");
      TH2F *twod0= (TH2F*)hfile1->Get("h_mapDepth1_HE");
      twod1->Sumw2();
      twod0->Sumw2();
      if(twod0->IsA()->InheritsFrom("TH2F")){
	...
	Cefz225->Sumw2();
      ...
      Cefz225->SetXTitle("#eta \b");
      Cefz225->SetYTitle("#phi \b");
      Cefz225->SetZTitle("Rate for TSmeanA in each event & cell out 2.3-5 - HE Depth1 \b");
      Cefz225->SetMarkerColor(2);
      Cefz225->SetLineColor(2);
      Cefz225->Draw("COLZ");
      ...
      aaaaaa1->SetMarkerSize(0.8);
      aaaaaa1->GetYaxis()->SetLabelSize(0.04);
      aaaaaa1->SetXTitle("TSmeanA in each event & cell HE \b");
      aaaaaa1->SetMarkerColor(2);
      aaaaaa1->SetLineColor(2);
      aaaaaa1->Draw("");
    ...
    for (int i=1;i<=nx;i++) {
	  ...
	  if(ccc1 < 2.3 || ccc1>5.)  Diffe_Depth1_HE->SetBinContent(i,j,ccc1);
      }
    }
      gPad->SetGridy();
      gPad->SetGridx();
      ...
      Diffe_Depth1_HE->SetZTitle("<TSmeanA> out 2.3-5 - HE Depth1 \b");
      ...
      c1->cd(4);
      TH1F* diffTSmeanA_Depth1_HE = new TH1F("diffTSmeanA_Depth1_HE","", 100, -1.,11.);
      int nx = Ceff->GetXaxis()->GetNbins();
      int ny = Ceff->GetYaxis()->GetNbins();
      for (int i=1;i<=nx;i++) {
	for (int j=1;j<=ny;j++) {
    ...
    //======================================================================
      ...
      TH2F *twod1= (TH2F*)hfile1->Get("h_mapDepth2TSmeanA_HE");
	...
	Ceff->Sumw2();
      ...
      c1->cd(1);
      TH2F *twod1= (TH2F*)hfile1->Get("h_mapDepth2TSmeanA225_HE");
      TH2F *twod0= (TH2F*)hfile1->Get("h_mapDepth2_HE");
      twod1->Sumw2();
      twod0->Sumw2();
      if(twod0->IsA()->InheritsFrom("TH2F")){
	...
	Cefz225->Sumw2();
      ...
      Cefz225->SetXTitle("#eta \b");
      Cefz225->SetYTitle("#phi \b");
      Cefz225->SetZTitle("Rate for TSmeanA in each event & cell out 2.3-5 - HE Depth2 \b");
      Cefz225->SetMarkerColor(2);
      Cefz225->SetLineColor(2);
      Cefz225->Draw("COLZ");
    ...
    for (int i=1;i<=nx;i++) {
	  ...
	  if(ccc1 < 2.3 || ccc1>5.)  Diffe_Depth2_HE->SetBinContent(i,j,ccc1);
      }
    }
      gPad->SetGridy();
      gPad->SetGridx();
      ...
      Diffe_Depth2_HE->SetZTitle("<TSmeanA> out 2.3-5 - HE Depth2 \b");
      ...
      c1->cd(4);
      TH1F* diffTSmeanA_Depth2_HE = new TH1F("diffTSmeanA_Depth2_HE","", 100, -1.,11.);
      int nx = Ceff->GetXaxis()->GetNbins();
      int ny = Ceff->GetYaxis()->GetNbins();
      for (int i=1;i<=nx;i++) {
	for (int j=1;j<=ny;j++) {
    ...
    //======================================================================
      ...
      TH2F *twod1= (TH2F*)hfile1->Get("h_mapDepth3TSmeanA_HE");
	...
	Ceff->Sumw2();
      ...
      c1->cd(1);
      TH2F *twod1= (TH2F*)hfile1->Get("h_mapDepth3TSmeanA225_HE");
      TH2F *twod0= (TH2F*)hfile1->Get("h_mapDepth3_HE");
      twod1->Sumw2();
      twod0->Sumw2();
      if(twod0->IsA()->InheritsFrom("TH2F")){
	...
	Cefz225->Sumw2();
      ...
      Cefz225->SetXTitle("#eta \b");
      Cefz225->SetYTitle("#phi \b");
      Cefz225->SetZTitle("Rate for TSmeanA in each event & cell out 2.3-5 - HE Depth3 \b");
      Cefz225->SetMarkerColor(2);
      Cefz225->SetLineColor(2);
      Cefz225->Draw("COLZ");
    ...
    for (int i=1;i<=nx;i++) {
	  ...
	  if(ccc1 < 2.3 || ccc1>5.)  Diffe_Depth3_HE->SetBinContent(i,j,ccc1);
      }
    }
      gPad->SetGridy();
      gPad->SetGridx();
      ...
      Diffe_Depth3_HE->SetZTitle("<TSmeanA> out 2.3-5 - HE Depth3 \b");
      ...
      c1->cd(4);
      TH1F* diffTSmeanA_Depth3_HE = new TH1F("diffTSmeanA_Depth3_HE","", 100, -1.,11.);
      int nx = Ceff->GetXaxis()->GetNbins();
      int ny = Ceff->GetYaxis()->GetNbins();
      for (int i=1;i<=nx;i++) {
	for (int j=1;j<=ny;j++) {
    ...
    //======================================================================
      ...
      TH2F *twod1= (TH2F*)hfile1->Get("h_mapDepth1TSmeanA_HF");
	...
	Ceff->Sumw2();
      ...
      c1->cd(1);
      TH2F *twod1= (TH2F*)hfile1->Get("h_mapDepth1TSmeanA225_HF");
      TH2F *twod0= (TH2F*)hfile1->Get("h_mapDepth1_HF");
      twod1->Sumw2();
      twod0->Sumw2();
      if(twod0->IsA()->InheritsFrom("TH2F")){
	...
	Cefz225->Sumw2();
      ...
      Cefz225->SetXTitle("#eta \b");
      Cefz225->SetYTitle("#phi \b");
      Cefz225->SetZTitle("Rate for TSmeanA in each event & cell out 2.3-5 - HF Depth1 \b");
      Cefz225->SetMarkerColor(2);
      Cefz225->SetLineColor(2);
      Cefz225->Draw("COLZ");
      
      c1->cd(2);
      TH1F *aaaaaa1= (TH1F*)hfile1->Get("h_TSmeanA_HF");
      gPad->SetLogy();
      aaaaaa1->SetMarkerStyle(20);
      aaaaaa1->SetMarkerSize(0.8);
      aaaaaa1->GetYaxis()->SetLabelSize(0.04);
      aaaaaa1->SetXTitle("TSmeanA in each event & cell HF \b");
      aaaaaa1->SetMarkerColor(2);
      aaaaaa1->SetLineColor(2);
      aaaaaa1->Draw("");
    ...
    for (int i=1;i<=nx;i++) {
	  ...
	  if(ccc1 < 2.3 || ccc1>5. )  Diffe_Depth1_HF->SetBinContent(i,j,ccc1);
      }
    }
      gPad->SetGridy();
      gPad->SetGridx();
      ...
      Diffe_Depth1_HF->SetZTitle("<TSmeanA> out 2.3-5 - HF Depth1 \b");
      ...
      c1->cd(4);
      TH1F* diffTSmeanA_Depth1_HF = new TH1F("diffTSmeanA_Depth1_HF","", 100, -1.,11.);
      int nx = Ceff->GetXaxis()->GetNbins();
      int ny = Ceff->GetYaxis()->GetNbins();
      for (int i=1;i<=nx;i++) {
	for (int j=1;j<=ny;j++) {
    ...
    //======================================================================
      ...
      TH2F *twod1= (TH2F*)hfile1->Get("h_mapDepth2TSmeanA_HF");
	...
	Ceff->Sumw2();
      ...
      c1->cd(1);
      TH2F *twod1= (TH2F*)hfile1->Get("h_mapDepth2TSmeanA225_HF");
      TH2F *twod0= (TH2F*)hfile1->Get("h_mapDepth2_HF");
      twod1->Sumw2();
      twod0->Sumw2();
      if(twod0->IsA()->InheritsFrom("TH2F")){
	...
	Cefz225->Sumw2();
      ...
      Cefz225->SetXTitle("#eta \b");
      Cefz225->SetYTitle("#phi \b");
      Cefz225->SetZTitle("Rate for TSmeanA in each event & cell out 2.3-5 - HF Depth2 \b");
      Cefz225->SetMarkerColor(2);
      Cefz225->SetLineColor(2);
      Cefz225->Draw("COLZ");
    ...
    for (int i=1;i<=nx;i++) {
	  ...
	  if(ccc1 < 2.3 || ccc1>5.)  Diffe_Depth2_HF->SetBinContent(i,j,ccc1);
      }
    }
      gPad->SetGridy();
      gPad->SetGridx();
      ...
      Diffe_Depth2_HF->SetZTitle("<TSmeanA> out 2.3-5 - HF Depth2 \b");
      ...
      c1->cd(4);
      TH1F* diffTSmeanA_Depth2_HF = new TH1F("diffTSmeanA_Depth2_HF","", 100, -1.,11.);
      int nx = Ceff->GetXaxis()->GetNbins();
      int ny = Ceff->GetYaxis()->GetNbins();
      for (int i=1;i<=nx;i++) {
	for (int j=1;j<=ny;j++) {
    ...
    //======================================================================
      ...
      TH2F *twod1= (TH2F*)hfile1->Get("h_mapDepth4TSmeanA_HO");
	...
	Ceff->Sumw2();
      ...
      c1->cd(1);
      TH2F *twod1= (TH2F*)hfile1->Get("h_mapDepth4TSmeanA225_HO");
      TH2F *twod0= (TH2F*)hfile1->Get("h_mapDepth4_HO");
      twod1->Sumw2();
      twod0->Sumw2();
      if(twod0->IsA()->InheritsFrom("TH2F")){
	...
	Cefz225->Sumw2();
      ...
      Cefz225->SetXTitle("#eta \b");
      Cefz225->SetYTitle("#phi \b");
      Cefz225->SetZTitle("Rate for TSmeanA in each event & cell out 2.3-5.5 - HO Depth4 \b");
      Cefz225->SetMarkerColor(2);
      Cefz225->SetLineColor(2);
      Cefz225->Draw("COLZ");
      
      c1->cd(2);
      TH1F *aaaaaa1= (TH1F*)hfile1->Get("h_TSmeanA_HO");
      gPad->SetLogy();
      aaaaaa1->SetMarkerStyle(20);
      aaaaaa1->SetMarkerSize(0.8);
      aaaaaa1->GetYaxis()->SetLabelSize(0.04);
      aaaaaa1->SetXTitle("TSmeanA in each event & cell HO \b");
      aaaaaa1->SetMarkerColor(2);
      aaaaaa1->SetLineColor(2);
      aaaaaa1->Draw("");
    ...
    for (int i=1;i<=nx;i++) {
	  ...
	  if(ccc1 < 2.3 || ccc1>5.)  Diffe_Depth4_HO->SetBinContent(i,j,ccc1);
      }
    }
      gPad->SetGridy();
      gPad->SetGridx();
      ...
      Diffe_Depth4_HO->SetZTitle("<TSmeanA> out 2.3-5 - HO Depth4 \b");
      ...
      c1->cd(4);
      TH1F* diffTSmeanA_Depth4_HO = new TH1F("diffTSmeanA_Depth4_HO","", 100, -1.,11.);
      int nx = Ceff->GetXaxis()->GetNbins();
      int ny = Ceff->GetYaxis()->GetNbins();
      for (int i=1;i<=nx;i++) {
	for (int j=1;j<=ny;j++) {
