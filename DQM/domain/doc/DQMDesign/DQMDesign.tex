...
\begin{figure}[hbtp]
  ...
  \rotatebox{90}{
    \resizebox{17cm}{!}
	{\includegraphics{figures/generic_diagram}} }
...
\pdfbookmark[3]{Limitations}{Limitations}
%==========================================
%
...
\pdfbookmark[4]{Requirements}{Requirements}
%==========================================
%
\subsection{General}
...
\pdfbookmark[5]{Appendix}{Appendix}
